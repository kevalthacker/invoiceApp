    ...
    <div class="">
        ...
        <div class="flex mb-4">
            ...
            <div class="w-3/4 p-12">
                <form class="w-full max-w-xl" @submit.prevent="addInvoice" method="post">
                    <div class="font-bold text-xl mb-2 px-8 pt-6">Add New Invoice</div>

                    <div class="px-8 pt-6 mb-4" v-if="success">
                        <div class="bg-teal-100 border border-teal-400  px-4 py-3 rounded relative" role="alert">
                            <span class="block sm:inline">Invoice created successfully.</span>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addInvoice(e) {
                var app = this;
                this.axios.post('/addInvoice', app.invoice)
                    .then(function(resp) {
                        app.success = true;
                        e.target.reset();
                    })
